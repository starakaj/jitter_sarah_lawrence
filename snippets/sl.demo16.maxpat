...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 110.0, 466.0, 164.0, 64.0 ],
					"presentation_rect" : [ 146.5, 477.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "All of the same manipulations that we did for simple shapes, we can do for videos as well"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 441.0, 194.0, 46.0, 22.0 ],
					"style" : "",
					"text" : "vol 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 371.0, 194.0, 53.0, 22.0 ],
					"style" : "",
					"text" : "loop 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 321.5, 455.0, 57.0, 22.0 ],
					"presentation_rect" : [ 526.5, 536.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "angle $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 321.5, 425.0, 112.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 321.5, 395.0, 116.0, 22.0 ],
					"presentation_rect" : [ 526.5, 476.0, 0.0, 0.0 ],
					"size" : 1.0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 287.5, 487.0, 132.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 321.5, 618.0, 65.0, 22.0 ],
					"style" : "",
					"text" : "tiles $1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 321.5, 588.0, 99.0, 22.0 ],
					"style" : "",
					"text" : "scale 0. 1. 1. 16."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 321.5, 558.0, 116.0, 22.0 ],
					"size" : 1.0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 287.5, 652.0, 117.0, 22.0 ],
					"style" : "",
...
,
					"patching_rect" : [ 544.0, 354.0, 80.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 538.5, 425.0, 93.0, 66.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 544.0, 392.0, 82.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Simple video manipulation"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 287.5, 712.0, 63.0, 22.0 ],
					"style" : "",
					"text" : "s to-world"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 362.5, 339.5, 553.5, 339.5 ],
					"source" : [ "obj-8", 1 ]
				}
