...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 735.833374, 393.0, 137.0, 51.0 ],
					"presentation_rect" : [ 740.0, 386.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "4. Move the mouse left and right to shift the image"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 596.0, 373.0, 62.0, 22.0 ],
					"style" : "",
					"text" : "r mouseX"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 596.0, 469.0, 59.0, 22.0 ],
					"style" : "",
					"text" : "shift $1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 596.0, 436.5, 109.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 596.0, 410.0, 124.0, 17.0 ],
					"size" : 1.0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 552.0, 510.0, 147.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 507.0, 587.0, 63.0, 22.0 ],
					"presentation_rect" : [ 791.833313, 562.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "r blanktex"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 316.5, 587.0, 157.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 552.0, 306.0, 126.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 552.0, 267.0, 63.0, 22.0 ],
					"style" : "",
					"text" : "r blanktex"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 652.333374, 75.833344, 150.0, 33.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 491.0, 180.666687, 65.0, 22.0 ],
					"style" : "",
					"text" : "s blanktex"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 721.333374, 112.666687, 110.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 589.333313, 81.333344, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 589.333313, 112.666687, 125.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 491.0, 112.666687, 79.0, 22.0 ],
					"style" : "",
					"text" : "r renderbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 491.0, 148.0, 293.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 316.5, 643.0, 160.0, 22.0 ],
					"style" : "",
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 202.0, 558.5, 326.0, 558.5 ],
					"source" : [ "obj-8", 0 ]
				}
